...
// to create a multinode, containerized Kubernetes cluster that is running
// inside a Prow DinD container (i.e. Docker-in-Docker-in-Docker, or DinDinD
// configuration).
...
var (
	...
	// kubeadm-dind-cluster script
	kdcScript = "/workspace/github.com/leblancd/kubeadm-dind-cluster/fixed/dind-cluster-stable.sh"
...
func NewDeployer(numNodes, ipMode string, control *process.Control) (*Deployer, error) {
...
func (l *hostCmder) execCmd(cmd string) *exec.Cmd {
