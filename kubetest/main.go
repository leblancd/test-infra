...
func defineFlags() *options {
	...
	flag.StringVar(&o.gceDinDImage, "gce-dind-image", "", "(gce-dind only) A pre-built kubeadm-dind-cluster docker image for node containers. If unset, it will be built from latest github.com://Mirantis/kubeadm-dind-cluster.")
...
func getDeployer(o *options) (deployer, error) {
	...
	case "gce-dind":
		return gcedind.NewDeployer(o.gcpProject, o.gcpZone, o.numNodes, o.ipMode, o.gceDinDImage, control)
	case "gke":
